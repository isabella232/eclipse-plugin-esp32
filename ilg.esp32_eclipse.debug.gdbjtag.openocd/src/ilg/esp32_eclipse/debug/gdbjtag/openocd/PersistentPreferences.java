...
package ilg.esp32_eclipse.debug.gdbjtag.openocd;
...
public class PersistentPreferences {
	...
	public static final String XTENSA_PATH = "xtensa.tools";
	public static final String XTENSA_PATH_OS = XTENSA_PATH + ".%s";
	public static final String IDF_PATH = "idf.path";
	public static final String IDF_PATH_OS = IDF_PATH + ".%s";
	
	public static final String XTENSATOOLS_PATH_DEPRECATED = "xtensa_tools";
	public static final String IDF_PATH_DEPRECATED = "idf_path";
