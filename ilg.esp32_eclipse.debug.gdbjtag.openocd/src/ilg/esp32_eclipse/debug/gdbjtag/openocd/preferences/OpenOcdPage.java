...
package ilg.esp32_eclipse.debug.gdbjtag.openocd.preferences;

import ilg.esp32_eclipse.core.preferences.DirectoryNotStrictVariableFieldEditor;
import ilg.esp32_eclipse.core.preferences.StringVariableFieldEditor;
import ilg.esp32_eclipse.debug.gdbjtag.openocd.Activator;
import ilg.esp32_eclipse.debug.gdbjtag.openocd.DefaultPreferences;
import ilg.esp32_eclipse.debug.gdbjtag.openocd.PersistentPreferences;
import ilg.esp32_eclipse.debug.gdbjtag.openocd.VariableInitializer;
import ilg.esp32_eclipse.debug.gdbjtag.openocd.ui.Messages;
...
public class OpenOcdPage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public static final String ID = "ilg.esp32_eclipse.debug.gdbjtag.openocd.preferencePage";
